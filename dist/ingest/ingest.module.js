...
exports.IngestModule = IngestModule = __decorate([
    (0, common_1.Module)({
        controllers: [ingest_controller_1.IngestController, courses_controller_1.CoursesController],
        providers: [ingest_service_1.IngestService, parser_service_1.ParserService, chunker_service_1.ChunkerService, embedding_service_1.EmbeddingService, database_service_1.DatabaseService],
